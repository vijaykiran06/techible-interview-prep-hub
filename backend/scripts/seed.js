...
- Two Pointer technique: Use two pointers (left and right) moving toward each other to solve problems like reversing an array or finding pairs that sum to a target. This turns O(n²) brute force into O(n).
- Sliding Window: Maintain a window of elements and slide it across the array. Used for problems like maximum sum subarray of size k, or longest substring without repeating characters.
